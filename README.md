...
<div class="avaliacao">
                <div class="avaliacao-user">Silva Santosw9w8</div>
                <div class="estrelas">⭐⭐⭐⭐⭐</div>
                <div class="avaliacao-texto">
                    Confiável
                </div>
            ...
            <div class="avaliacao">
                <div class="avaliacao-user">Lucas827sjzip</div>
                <div class="estrelas">⭐⭐⭐⭐⭐</div>
                <div class="avaliacao-texto">
                    Mnnnm
                </div>
            ...
            <div class="avaliacao">
                <div class="avaliacao-user">Naosei</div>
                <div class="estrelas">⭐⭐⭐⭐⭐</div>
                <div class="avaliacao-texto">
                    Mano parabéns
                </div>
            ...
            <div class="avaliacao">
                <div class="avaliacao-user">Luis</div>
                <div class="estrelas">⭐⭐⭐⭐⭐</div>
                <div class="avaliacao-texto">
                    Mano obg tava precisando
                </div>
                <span class="badge">✓ Verificado</span>
            </div>

            <div class="avaliacao">
                <div class="avaliacao-user">Xvidro</div>
                <div class="estrelas">⭐⭐⭐⭐⭐</div>
                <div class="avaliacao-texto">
                    Slkkkkk ksksksksksks
                </div>
                <span class="badge">✓ Verificado</span>
            </div>
